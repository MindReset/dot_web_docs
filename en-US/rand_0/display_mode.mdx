...
1. You have completed [Wi-Fi Time Sync](/docs/rand_0/wifi) so Rand/0 remembers an available Wi-Fi network.
...
You can enter from either of these locations:

- Main menu → **Display** → Confirm;
- **Settings** → **Display Mode** → Confirm.
...
| No remembered Wi-Fi | Complete [Wi-Fi Time Sync](/docs/rand_0/wifi) so the device can remember an available network. |
