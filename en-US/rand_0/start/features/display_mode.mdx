...
1. You have completed [Wi-Fi Time Sync](/docs/rand_0/start/wifi) so Rand/0 remembers an available Wi-Fi network.
...
| No remembered Wi-Fi | Complete [Wi-Fi Time Sync](/docs/rand_0/start/wifi) so the device can remember an available network. |
