...
1. Make sure you have <Link href="/docs/server/studio/api/get_api">retrieved and saved your API key</Link> in the Dot. App;
2. Make sure you own at least one device and have <Link href="/docs/server/studio/api/get_device_id">obtained its device serial number</Link>;
