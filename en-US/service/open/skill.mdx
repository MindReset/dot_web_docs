...
- **Canvas Push** - Turn your own data into custom cards, dashboards, and device screens
...
| Claude / MCP clients | Planned | Remote MCP is not available yet. Use the OpenAPI schema for now. No release window is confirmed. |
...
| MCP Registry | Planned | Registry metadata is not published yet. No release window is confirmed. |
