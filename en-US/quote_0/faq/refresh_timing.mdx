...
You can set both power and battery intervals from **1 minute to 12 hours** in Dot. App or through the Device Settings API. On battery, this interval controls how often Quote/0 wakes automatically to reconnect and check for new content.
