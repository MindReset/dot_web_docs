...
<Tabs items={['cURL', 'Python', 'JavaScript', 'TypeScript', 'Go', 'Rust']}>
  <Tab value="cURL">
    ```bash
    curl -X POST \
      https://dot.mindreset.tech/api/authV2/open/device/image \
  ...
  <Tab value="Python">
    ...
    url = "https://dot.mindreset.tech/api/authV2/open/device/image"
    headers = {
  ...
  <Tab value="JavaScript">
    ```javascript
    fetch("https://dot.mindreset.tech/api/authV2/open/device/image", {
      method: "POST",
      headers: {
        "Authorization": "Bearer {{API_KEY}}",
        "Content-Type": "application/json"
  ...
  <Tab value="Rust">
    ...
    fn main() {
        ...
        let url = "https://dot.mindreset.tech/api/authV2/open/device/image";
...
| `ditherKernel` | `string` | No       | `FLOYD_STEINBERG` | Dither algorithm (`THRESHOLD`, `ATKINSON`, `BURKES`, `FLOYD_STEINBERG`, `SIERRA2`, `STUCKI`, `JARVIS_JUDICE_NINKE`, `DIFFUSION_ROW`, `DIFFUSION_COLUMN`, `DIFFUSION_2D`) | Control dither algorithm   |
