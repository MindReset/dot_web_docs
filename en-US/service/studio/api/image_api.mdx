...
<Tabs items={['cURL', 'Python', 'JavaScript', 'TypeScript', 'Go', 'Rust']}>
  <Tab value="cURL">
    ```bash
    curl -X POST \
      https://dot.mindreset.tech/api/open/device/image \
  ...
  <Tab value="Python">
    ...
    url = "https://dot.mindreset.tech/api/open/device/image"
    headers = {
  ...
  <Tab value="JavaScript">
    ```javascript
    fetch("https://dot.mindreset.tech/api/open/device/image", {
      method: "POST",
      headers: {
        "Authorization": "Bearer {{API_KEY}}",
        "Content-Type": "application/json"
  ...
  <Tab value="Rust">
    ...
    fn main() {
        ...
        let url = "https://dot.mindreset.tech/api/open/device/image";
