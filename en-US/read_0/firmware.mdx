...
description: Build and flash the official Read/0 demo with ESP-IDF, then use its board support and drivers for your own firmware.
---

Build Read/0 firmware from the official demo repository, modify its demo pages, or reuse its board support and chip drivers.
